...
// 차량 아이디 가져오기 
 ...
 %>
   ...
   <nav>
    ...
    <div class="main">
        <div class="wrapper">
            <div class="title"><h1 class="car_name">모델 : <%=con.MODEL %></h1><%if(price.length()==4){ %>
           ...
           <div class="btn_wrap">
                <div class="swiper mySwiper4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><div class="else_wrap"><img src="resource/img/sub1.png" width="100%" height="100%"></div></div>
                        <div class="swiper-slide"><div class="else_wrap"><img src="resource/img/sub2.png" width="100%" height="100%"></div></div>
                        <div class="swiper-slide"><div class="else_wrap"><img src="resource/img/sub3.png" width="100%" height="100%"></div></div>
                    </div>
                </div>
            </div>
        </div>

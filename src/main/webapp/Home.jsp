...
<body>
	...
	<div class="main">
		<div class="wrapper">
			<div class="product">
				<div class="p_btn">
					<button onclick="Switch('Audi');color('one');" name="car_type"
						value="audi" class="sbtn" id="one">
						<div>
							<img src="resource/img/Audi.png" width="65px" height="40px" />
							<div>AUDI</div>
						</div>
					</button>
					<button onclick="Switch('Toyota');color('two');" name="car_type"
						value="toyota" class="sbtn" id="two">
						<div>
							<img src="resource/img/toyota.png" width="65px" height="40px" />
							<div>TOYOTA</div>
						</div>
					</button>
					<button onclick="Switch('Hyundai');color('three');" name="car_type"
						value="hyundai" class="sbtn" id="three">
						<div>
							<img src="resource/img/Hyundai.png" width="65px" height="40px" />
							<div>HYUNDAI</div>
						</div>
					</button>
					<button onclick="Switch('Vw');color('four');" name="car_type"
						value="vw" class="sbtn" id="four">
						<div>
							<img src="resource/img/vw.png" width="65px" height="40px" />
							<div>VW</div>
						</div>
					</button>
					<button onclick="Switch('Bmw');color('five');" name="car_type"
						value="bmw" class="sbtn" id="five">
						<div>
				...
				<div class="p_img" id="Audi" style="display: block;">
					<div class="swiper mySwiper2">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								<div class="car_wrap">
									<img src="resource/img/<%=file.toString().substring(67)%>"
